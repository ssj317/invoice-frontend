			...
			<div className="max-w-6xl mx-auto px-4">
				...
				<div className="bg-[#FFFDF5] rounded-lg shadow-sm border border-[#EAF4F1] p-6 mb-6 print:hidden">
					<div className="flex items-center justify-between">
						<h2 className="text-2xl font-bold text-gray-900">Delivery Challan Preview</h2>
				...
				<div ref={invoiceRef} className="bg-white shadow-lg p-12">
					...
					<div className="flex justify-between items-start mb-8">
						<div>
							<h1 className="text-4xl font-bold text-[#178C92] mb-3">Delivery Challan</h1>
					...
					<div className="grid grid-cols-2 gap-8 mb-8">
						{/* Consignor */}
						<div>
							<h3 className="text-lg font-bold text-[#164A41] mb-3">Consignor</h3>
						...
						{/* Consignee */}
						<div>
							<h3 className="text-lg font-bold text-[#164A41] mb-3">Consignee</h3>
							{selectedClientData ? (
								<div className="bg-[#FFFDF5] p-5 rounded-lg border border-[#EAF4F1]">
