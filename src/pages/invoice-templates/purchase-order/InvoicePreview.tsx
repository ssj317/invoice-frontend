			...
			<div className="max-w-6xl mx-auto px-4">
				...
				<div ref={invoiceRef} className="bg-white shadow-lg p-12">
					...
					<div className="flex justify-between items-start mb-8">
						<div>
							<h1 className="text-4xl font-bold text-[#178C92] mb-3">Purchase Order</h1>
					...
					<div className="grid grid-cols-2 gap-8 mb-8">
						{/* Vendor */}
						<div>
							<h3 className="text-lg font-bold text-[#164A41] mb-3">Vendor</h3>
						...
						{/* Buyer */}
						<div>
							<h3 className="text-lg font-bold text-[#164A41] mb-3">Buyer</h3>
							{selectedClientData ? (
								<div className="bg-[#FFFDF5] p-5 rounded-lg border border-[#EAF4F1]">
