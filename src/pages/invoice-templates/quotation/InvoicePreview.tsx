...
// 						<div>
// 							<h1 className="text-4xl font-bold text-[#178C92] mb-3">Quotation</h1>
...
// 						{/* From */}
// 						<div>
// 							<h3 className="text-lg font-bold text-[#164A41] mb-3">From</h3>
...
// 						{/* To */}
// 						<div>
// 							<h3 className="text-lg font-bold text-[#164A41] mb-3">To</h3>
// 							{selectedClientData ? (
// 								<div className="bg-[#FFFDF5] p-5 rounded-lg border border-[#EAF4F1]">
