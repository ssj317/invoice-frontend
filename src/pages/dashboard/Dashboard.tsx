...
//               <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-[#178C92] rounded-full flex items-center justify-center text-white text-lg sm:text-xl md:text-xl lg:text-2xl font-bold flex-shrink-0">
...
//             {/* Subscription Info */}
//             {subscription && (
//               <div className="w-full sm:w-auto flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-[#EAF4F1] border border-[#d0eae8] rounded flex-shrink-0">
//                 <span className="text-xs sm:text-sm font-medium text-[#007078]">
//                   {subscription.plan.charAt(0).toUpperCase() + subscription.plan.slice(1)} Plan
//                 </span>
//                 <span className="text-xs text-[#178C92]">
...
//                   <p className="text-xs sm:text-sm font-medium text-[#007078] capitalize">{lastInvoice.templateType?.replace(/-/g, ' ')}</p>
//                 </div>
...
//               className="w-full flex items-center justify-center gap-1.5 px-3 py-2 sm:py-2.5 text-[#178C92] border border-[#178C92] rounded hover:bg-[#EAF4F1] transition-colors text-xs sm:text-sm font-medium mb-2 whitespace-nowrap"
//             >
...
//               className="w-full flex items-center justify-center gap-2 text-[#178C92] hover:underline text-xs sm:text-sm"
//             >
...
//                 <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg p-2.5 sm:p-3 mb-3 sm:mb-4 border border-[#d0eae8]">
//                   <div className="space-y-2 text-[10px] sm:text-xs">
//                     <div className="flex justify-between">
//                       <span className="text-gray-700">Plan:</span>
//                       <span className="font-semibold text-[#007078]">
...
//                         </div>
//                         {!trialInfo.isTrialActive && (
//                           <div className="pt-2 border-t border-[#d0eae8]">
...
//                     className="w-full flex items-center justify-center gap-1.5 px-3 py-2 sm:py-2.5 bg-[#178C92] text-white rounded hover:bg-[#007078] transition-colors text-xs sm:text-sm font-medium mb-2 whitespace-nowrap"
//                   >
...
//             {[
//               { label: 'Invoice', icon: <FileText className="w-6 h-6" />, route: '/invoice/invoice-generator', color: 'text-[#178C92] bg-[#EAF4F1] border-[#d0eae8] hover:bg-[#EAF4F1]' },
...
//               {/* Subscription Info */}
//               {subscription && (
//                 <div className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-[#EAF4F1] border border-[#d0eae8] rounded flex-shrink-0">
//                   <span className="text-xs sm:text-sm font-medium text-[#007078]">
//                     {subscription.plan.charAt(0).toUpperCase() + subscription.plan.slice(1)} Plan
//                   </span>
//                   <span className="text-xs text-[#178C92]">
...
//                 className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-[#178C92] text-white rounded-lg hover:bg-[#007078] transition-all shadow-sm hover:shadow-md flex-shrink-0"
//               >
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        if (
          ...
          invoiceResponse.value.success
        ) {
          setLastInvoice(
            invoiceResponse.value.data.invoices?.[0] || null
          );
        }

        if (
          quotationResponse.status === 'fulfilled' &&
          quotationResponse.value.success
        ) {
          setLastQuotation(
            quotationResponse.value.data.invoices?.[0] || null
          );
        }
      ...
      ">
        ...
        ">
          ...
          <div className="
            ...
            p-4
            sm:p-5
            hover:shadow-[0_10px_30px_rgba(22,74,65,0.08)]
            transition-all
          ">
            ...
            {loading ? (
              <div className="space-y-3 mb-4">
                ...
                <div className="h-4 bg-[#EAF4F1] rounded animate-pulse" />
                <div className="h-4 bg-[#EAF4F1] rounded animate-pulse" />
                <div className="h-4 bg-[#EAF4F1] rounded animate-pulse" />
              ...
              ">
                ...
                <div>
                  <p className="text-[10px] sm:text-xs text-[#49645F]/70 mb-0.5">
                    Type
                  </p>
                  ...
                  <p className="
                    ...
                    capitalize
                  ">
                    {lastInvoice.templateType?.replace(/-/g, ' ')}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="
                    ...
                    line-clamp-2
                  ">
                    {lastInvoice.clientDetails?.name ||
                      lastInvoice.selectedClient ||
                      'N/A'}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <span
                    className={`
                      ...
                      font-medium
                      ${
                        lastInvoice.status === 'completed'
                          ? 'bg-[#EAF4F1] text-[#007078]'
                          : lastInvoice.status === 'paid'
                            ? 'bg-[#EAF4F1] text-[#178C92]'
                            : lastInvoice.status === 'sent'
                              ? 'bg-[#E7B83C]/15 text-[#8A6A13]'
                              : 'bg-[#F8F4E1] text-[#49645F]'
                      }
                    `}
                  >
                    {lastInvoice.status?.charAt(0).toUpperCase() +
                      lastInvoice.status?.slice(1)}
                  </span>
              ...
              ">
                ...
                <div>
                  ...
                  <p className="
                    ...
                    line-clamp-2
                  ">
                    {lastQuotation.clientDetails?.name ||
                      lastQuotation.selectedClient ||
                      'N/A'}
                  </p>
                </div>
                ...
                <div>
                  ...
                  ">
                    {formatCurrency(
                      lastQuotation.totals?.grandTotal,
                      lastQuotation.currency?.symbol
                    )}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="
                    ...
                    text-[#164A41]
                  ">
                    {formatDate(lastQuotation.invoiceDate)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <span
                    className={`
                      ...
                      font-medium
                      ${
                        lastQuotation.status === 'completed'
                          ? 'bg-[#EAF4F1] text-[#007078]'
                          : lastQuotation.status === 'sent'
                            ? 'bg-[#E7B83C]/15 text-[#8A6A13]'
                            : 'bg-[#F8F4E1] text-[#49645F]'
                      }
                    `}
                  >
                    {lastQuotation.status?.charAt(0).toUpperCase() +
                      lastQuotation.status?.slice(1)}
                  </span>
        ...
        <div className="mt-6 sm:mt-8 md:mt-10">
          ...
          ">
            ...
            {[
              ...
              {
                label: 'Zorintech Invoice',
                icon: <FileText className="w-6 h-6" />,
                route: '/proposal/zorintech',
              },
            ]
              .filter(
                (_, index) =>
                  hasDocumentAccess || index < 6
              )
              .map((item) => (
                <button
                  key={item.route}
                  ...
                  className="
                    ...
                    transition-all
                    hover:bg-[#EAF4F1]
                    hover:border-[#178C92]/30
                    hover:text-[#007078]
                    hover:shadow-[0_8px_24px_rgba(22,74,65,0.08)]
                  "
                >
