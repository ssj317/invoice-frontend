...
//     // Handler for Suzlon logo navigation
...
//             {/* Top Teal Navigation Bar - Fixed */}
//             <div className="bg-[#178C92] text-white z-20 fixed top-0 left-0 right-0">
//                 <div className="flex items-center justify-between px-3 sm:px-6 py-3">
//                     <div className="flex items-center gap-2 sm:gap-3">
//                         <button
//                             onClick={toggleSidebar}
//                             className="p-1 hover:bg-[#0f6368] rounded"
//                         >
...
//                         > 
//                             <img src="/suzlon-nav.png" alt="Suzlon Logo" className="w-16 h-12 sm:w-16" /> 
//                         </button>
//                     </div>
...
//                             className="hidden sm:flex items-center gap-2 bg-[#007078] rounded-full px-3 py-1.5 hover:bg-purple-800 transition-colors cursor-pointer"
//                         >
//                             <div className="w-7 h-7 bg-white rounded-full flex items-center justify-center">
//                                 <span className="text-[#178C92] font-semibold text-sm">L</span>
//                             </div>
...
//                         {/* <button
//                             onClick={() => setShowAccountManagerModal(true)}
//                             className="sm:hidden p-1.5 bg-[#007078] rounded-full hover:bg-purple-800 transition-colors"
//                         >
//                             <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
//                                 <span className="text-[#178C92] font-semibold text-xs">L</span>
//                             </div>
//                         </button> */}

//                         {/* <button className="hidden md:block p-2 hover:bg-[#007078] rounded">
...
//                         <button className="p-1.5 sm:p-2 hover:bg-[#0f6368] rounded relative">
...
//                                 className="w-8 h-8 sm:w-10 sm:h-10 bg-[#0f6368] rounded-full flex items-center justify-center font-semibold hover:bg-[#0a4a4e] text-base sm:text-lg transition-colors z-50 relative"
//                             >
...
//                                                 <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-[#178C92] to-[#0f6368] rounded-full flex items-center justify-center text-white text-xl sm:text-2xl font-bold">
//                                                     {userName.charAt(0).toUpperCase()}
//                                                 </div>
//                                                 <div className="flex-1 min-w-0">
//                                                     <h3 className="text-base sm:text-lg font-bold text-gray-900 truncate">{userName}</h3>
...
//                                             <button className="flex items-center gap-2 text-[#178C92] hover:text-[#0f6368] font-medium text-xs sm:text-sm">
...
//                                                 <button className="hover:text-[#178C92]">Blog</button>
//                                                 <span>•</span>
//                                                 <button className="hover:text-[#178C92]">About</button>
//                                                 <span>•</span>
//                                                 <button className="hover:text-[#178C92]">Privacy</button>
//                                                 <span>•</span>
//                                                 <button className="hover:text-[#178C92]">FAQs</button>
//                                             </div>
//                                         </div>
//                                     </div>
//                                 </>
...
//                             <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-[#178C92] to-[#0f6368] rounded-full flex items-center justify-center flex-shrink-0">
//                                 <span className="text-white text-2xl sm:text-3xl font-bold">S</span>
//                             </div>
//                             <div>
//                                 <h2 className="text-lg sm:text-2xl font-bold text-gray-900 mb-1">Hi, I am {userName}</h2>
...
//                             <p>
//                                 I've worked with 160+ amazing clients (just like you!) to ensure they get the most from Suzlon.
//                             </p>
//                             <p>
...
//                         <button className="w-full bg-[#178C92] hover:bg-[#0f6368] text-white font-semibold py-3 sm:py-4 rounded-xl mb-3 sm:mb-4 transition-colors text-sm sm:text-base">
//                             Request Call Back
//                         </button>
...
//                             {/* Email Button */}
//                             <a
//                                 href="mailto:support@suzlon.com"
...
//                                 <span className="text-xs sm:text-sm truncate">support@suzlon.com</span>
//                             </a>
    ...
    return (
        <div className="h-screen bg-gray-50 flex flex-col">
            ...
            <div className="bg-[#178C92] text-white z-20 fixed top-0 left-0 right-0">
                ...
                <div className="flex items-center justify-between px-3 sm:px-6 py-3">
                    ...
                    <div className="flex items-center gap-1 sm:gap-4">
                        ...
                        >
                            <div className="w-7 h-7 bg-white rounded-full flex items-center justify-center">
                                <span className="text-[#178C92] font-semibold text-sm">
                                    L
                                </span>
                            </div>
                            ...
                            <div className="text-xs">
                                ...
                                <div className="text-purple-200 text-xxs">
                        ...
                        */}
                        ...
                        {/* Mobile Account Manager - Disabled */}
                        {/*
                        <button
                            onClick={() => setShowAccountManagerModal(true)}
                            className="sm:hidden p-1.5 bg-[#007078] rounded-full hover:bg-purple-800 transition-colors"
                                    ...
                                    <div className="absolute right-0 mt-2 w-72 sm:w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-[9999] pointer-events-auto">
                                        ...
                                        <div className="px-4 sm:px-6 py-3 sm:py-4 border-t border-gray-200 bg-gray-50">
                                            ...
                                            <div className="flex items-center justify-center gap-2 sm:gap-4 text-xs text-gray-600">
                                                ...
                                                <button className="hover:text-[#178C92]">
                                                    Blog
                                                </button>
            ...
            <div className="flex flex-1 overflow-hidden pt-[52px] sm:pt-[60px]">
                ...
                {/* =====================================================
                    SIDEBAR COMPLETELY DISABLED
                ===================================================== */}

                {/*
                <div
                    className={`fixed top-[52px] sm:top-[60px] left-0 bottom-0 z-30 transition-all duration-300 ${
                ...
                <>
                    ...
                    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[95%] sm:w-full max-w-2xl bg-white rounded-2xl shadow-2xl z-[101] p-4 sm:p-8 max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 text-xs sm:text-base text-gray-700">
                            ...
                            <p>
                                I've worked with 160+ amazing clients (just like you!)
                                to ensure they get the most from Suzlon.
                            </p>

                            <p>
                                When not working, I am usually busy reading books,
                                traveling, or streaming Netflix:)
                            </p>

                            <p>
                                If you ever need any help with demos, setup,
                                customisations, upgrades, extensions, or anything else,
                                I am just a message or call away!
                            </p>
