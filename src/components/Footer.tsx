...
const Footer = () => {
	...
	return (
		<footer className="w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-300 relative overflow-hidden">
			{/* Top border gradient */}
			<div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#178C92] via-[#1aa3aa] to-[#178C92]"></div>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-11 gap-8 lg:gap-2 mb-6">
					...
					<div className=" lg:col-span-3 flex flex-col gap-3  sm:gap-6">
						...
						<div className="flex flex-col ml-6 ">
							...
							<div className="flex gap-2 mr-4">
								<a
									href="#facebook"
									className="group w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-[#178C92] transition-all duration-300 transform hover:scale-110"
									aria-label="Facebook"
								>
									<svg
								...
								<a
									href="https://www.linkedin.com/company/suzlon/"
									className="group w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-[#178C92] transition-all duration-300 transform hover:scale-110"
									aria-label="LinkedIn"
								>
									<svg
								...
								<a
									href="https://www.instagram.com/suzlon/"
									className="group w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-[#178C92] transition-all duration-300 transform hover:scale-110"
					...
					<div className="lg:col-span-2 px-4">
						<h3 className="text-white text-lg font-bold mb-6 relative">
							Company
							<span className="absolute bottom-0 left-0 w-12 h-1 bg-[#178C92] -mb-3"></span>
						</h3>
						<ul className="space-y-3">
							{companyLinks.map((link) => (
								<li key={link.name}>
									...
									>
										<span className="w-0 group-hover:w-2 h-0.5 bg-[#178C92] mr-0 group-hover:mr-2 transition-all duration-300"></span>
										{link.name}
									</a>
								</li>
							))}
					...
					<div className="lg:col-span-2 px-3">
						...
						<div className="space-y-2">
							...
							>
								<div className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center group-hover:bg-[#178C92] transition-all duration-300">
							...
							>
								...
								<div className="flex flex-col">
									<span className="text-sm font-medium break-all">care@suzlon.com</span>
								</div>
							</a>
						</div>
					</div>
					...
					<div className="max-w-2xl mx-auto text-center">
						...
						<div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
							<input
								...
								className="flex-1 px-4 mx-2 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#178C92] transition-colors"
							/>
							<button className="px-6 mx-2 py-3 bg-[#178C92] hover:bg-[#0f6368] text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105">
								Subscribe
							</button>
						</div>
					</div>
				...
				<div className="border-t border-gray-800 pt-2 mt-4">
					<div className="flex flex-col md:flex-row justify-between items-center gap-4">
						<p className="text-gray-400 text-sm text-center md:text-left">
							&copy; 2025 Suzlon. All rights reserved.
						</p>
